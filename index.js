...
const winner =
  finals2014["Home Team Goals"] > finals2014["Away Team Goals"]
    ? finals2014["Home Team Name"]
    : finals2014["Away Team Name"];
console.log(`The winner for the 2014 finals was ${winner}`);
